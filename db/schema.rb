...
ActiveRecord::Schema.define(version: 2020_08_05_055203) do
  ...
  create_table "buyer_sellers", force: :cascade do |t|
    ...
    t.index ["buyer_id"], name: "index_buyer_sellers_on_buyer_id"
  ...
  create_table "dishes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["chef_profile_id"], name: "index_dishes_on_chef_profile_id"
    t.index ["seller_id"], name: "index_dishes_on_seller_id"
  end
  ...
  create_table "sellers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["chef_profile_id"], name: "index_sellers_on_chef_profile_id"
  end
  ...
  add_foreign_key "buyer_sellers", "buyers"
  add_foreign_key "buyer_sellers", "sellers"
  add_foreign_key "buyers", "profiles"
  add_foreign_key "chef_profiles", "users"
  add_foreign_key "dishes", "chef_profiles"
  add_foreign_key "dishes", "sellers"
  add_foreign_key "profiles", "users"
  add_foreign_key "sellers", "chef_profiles"
end
